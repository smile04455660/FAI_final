...
class MyPlayer(BasePokerPlayer):
    ...
    def _encode_actions_input(self, hole_card, round_state):
        # action: fold, call, raise; 0, 1, 2
        hole_card = tuple([self._decode_card(card) for card in hole_card])
        inputs = []
        for ele in hole_card + self._decode_round_state(round_state):
    ...
    def _decode_round_state(self, round_state):
        ...
        return community_card, street, pot_amount,  dealer_btn, is_big_blind, small_blind_amount
    ...
    def declare_action(self, valid_actions, hole_card, round_state):
        ...
        self._encode_actions_input(hole_card, round_state)
    ...
    def receive_game_start_message(self, game_info):
        print("game start: ", json.dumps(game_info))
